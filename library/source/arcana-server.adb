...
is
   ...
   begin
      ...
      log ("Boulder count:" & Count'Image);
   end set_up_Boulders;



   procedure set_up_Trees
   is
      use openGL,
          gel.Math.Random;
      ...
      loop
         ...
         loop
            ...
            then
               ...
               Counter  := Counter + 1;
               the_Tree := gel.Forge.new_circle_Sprite (in_World => the_World'Access,
